...
void Create() {
    ...
    for (index = 0; index < numContacts; index++) {
        contactsList[index].id = index + 1;
        printf("Enter phone number of %d: ", index + 1);
        scanf("\n");
        gets(contactsList[index].phoneNumber);
        printf("Enter Name of %d: ", index + 1);
        scanf("\n");
        gets(contactsList[index].name);
        printf("Enter email of %d: ", index + 1);
        scanf("\n");
        gets(contactsList[index].email);
        printf("Enter company name of %d: ", index + 1);
        scanf("\n");
        gets(contactsList[index].company);
    }
    createFlag = 1;
}
...
void Display() {
    if (createFlag == 1) {
        ...
        for (index = 0; index < numContacts + flag; index++) {
            printf("\n%5d %20s %25s %25s %20s", contactsList[index].id, contactsList[index].phoneNumber,
                   contactsList[index].name, contactsList[index].email, contactsList[index].company);
        }
        printf("\n");
...
void Insert() {
    contactsList[index].id = numContacts + flag + 1;
...
void Search() {
    if (numContacts == 0) {
        ...
        gets(value);
        for (index = 0; index < numContacts; index++) {
            if ((strcmp(contactsList[index].name, value)) == 0) {
